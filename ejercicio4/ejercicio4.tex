...
\begin{document}
\section{Ejercicio 4}
En primer lugar a continuación se presenta la tabla de verdad para la salida, la cual se presenta de la forma Y3, Y2, Y1, Y0 (bit más significativo al menos significativo y analogamente para la entrada).
\begin{table}[htb] 
\centering  
...
Con estos mapas de Karnaugh obtenemos para cada salida las siguientes expresiones en función de los mintérminos:
...
Y por último podemos representar las salidas en función de las entradas con las compuertas lógicas como se puede observar en los gráficos que mostramos a continuación, donde no representamos Y0 ya que es directamente igual a la entrada A0:
